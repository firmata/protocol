...
| 65H         | [REPORT_FEATURES_QUERY - proposal](https://github.com/firmata/protocol/issues/41) | proposed |
| 66H         | [REPORT_FEATURES_RESPONSE - proposal](https://github.com/firmata/protocol/issues/41) | proposed |
...
| Feature ID  | Feature name                       | Link to documentation  | Status     |
| ----------- | ---------------------------------- | ---------------------- | ---------- |
| 5EH         | DEVICE_QUERY                       |                        | proposed   |
| 5FH         | DEVICE_RESPONSE                    |                        | proposed   |
